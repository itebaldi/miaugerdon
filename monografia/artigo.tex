...
Enquanto alguns trabalhos abordam desinformação e outros investigam preconceito e empatia, Miaugerdon articula esses temas ao representar como uma percepção negativa sobre o outro pode ser construída antes do contato direto, a partir de informações e generalizações de uma fonte manipuladora. A experiência explora, assim, a relação entre controle informacional, formação de estereótipos e revisão de julgamentos.
