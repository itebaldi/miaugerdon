...
const INTRO := [
	...
	"Tudo seguia perfeitamente até Alfredo anunciar uma notícia terrível. Ele havia adotado outro gato, e o novo invasor chegaria amanhã.",
	...
	"Tomado pela indignação, Caju decidiu que não bastava defender a casa. Era hora de executar seu plano mais ambicioso e dominar o mundo antes da chegada do Soneca.",
